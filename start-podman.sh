#!/usr/bin/env bash
# ============================================================================
# Auralynq — Podman stack launcher for server yourIP
#
...
if [[ $DO_BUILD -eq 1 ]]; then
  CERT_HOST="${AURALYNQ_CERT_HOST:-yourIP}"
...
echo ""
echo "  Chat UI:     https://yourIP:8443"
echo "  ModelFit:    https://yourIP:8443/modelfit"
echo "  API health:  https://yourIP:8443/api/health"
echo "  API docs:    https://yourIP:8443/api/docs"
echo ""
...
echo "    → Go to https://yourIP:8443  and use the Upload / Ingest UI"
echo ""
